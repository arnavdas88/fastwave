...
async def toolbar(q: Q):
    ...
    q.page['meta'] = ui.meta_card(box='', layouts=[
        ui.layout(
            ...
            zones=[
                ...
                ui.zone('main', size='calc(98vh - 152px)', direction=ui.ZoneDirection.ROW, zones=[
                    ui.zone('description', size='40%'),
                    ui.zone('rhs', size='60%', direction=ui.ZoneDirection.COLUMN, zones=[
                        ui.zone('rtop', size='40%', direction=ui.ZoneDirection.ROW, zones=[
    ...
    q.page['example'] = ui.article_card(
        ...
        content=base64.b64decode("").decode('utf-8')
    )
